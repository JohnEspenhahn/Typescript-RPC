...
(function(process) {
  !function(global, factory) {
    ...
    function wrapIntoObservable(value) {
      return isObservable(value) ? value : isPromise(value) ? rxjs_observable_fromPromise.fromPromise(value) : rxjs_observable_of.of(value);
    }
    ...
    function advanceActivatedRoute(route) {
      if (route.snapshot) {
        ...
        route.snapshot = route._futureSnapshot, shallowEqual(currentSnapshot.queryParams, route._futureSnapshot.queryParams) || route.queryParams.next(route._futureSnapshot.queryParams), currentSnapshot.fragment !== route._futureSnapshot.fragment && route.fragment.next(route._futureSnapshot.fragment), shallowEqual(currentSnapshot.params, route._futureSnapshot.params) || route.params.next(route._futureSnapshot.params), shallowEqualArrays(currentSnapshot.url, route._futureSnapshot.url) || route.url.next(route._futureSnapshot.url), equalParamsAndUrlSegments(currentSnapshot, route._futureSnapshot) || route.data.next(route._futureSnapshot.data);
      } else
    ...
    var isPromise = _angular_core.__core_private__.isPromise,
        isObservable = _angular_core.__core_private__.isObservable,
        ...
        ApplyRedirects = function() {
          ...
          return ApplyRedirects.prototype.apply = function() {
            ...
            return route.redirectTo.startsWith("/") ? absoluteRedirect(newTree) : rxjs_operator_mergeMap.mergeMap.call(this.lineralizeSegments(route, newTree), function(newSegments) {
              ...
              return _this.expandSegment(injector, group, routes, newSegments, outlet, !1);
            });
            ...
            if ("**" === route.path)
              return route.loadChildren ? rxjs_operator_map.map.call(this.configLoader.load(injector, route.loadChildren), function(r) {
                return route._loadedConfig = r, new UrlSegmentGroup(segments, {});
            ...
            return id !== this.navigationId ? (this.location.go(this.urlSerializer.serialize(this.currentUrlTree)), this.routerEvents.next(new NavigationCancel(id, this.serializeUrl(url), "Navigation ID " + id + " is not equal to the current navigation id " + this.navigationId)), Promise.resolve(!1)) : new Promise(function(resolvePromise, rejectPromise) {
              ...
              var preActivation,
                  ...
                  preactivationTraverse$ = rxjs_operator_map.map.call(beforePreactivationDone$, function(_a) {
                    ...
                    return preActivation = new PreActivation(snapshot, _this.currentRouterState.snapshot, _this.injector), preActivation.traverse(_this.outletMap), {
                      appliedUrl: appliedUrl,
                      snapshot: snapshot
                    };
                  }),
        ...
        RouterInitializer = function() {
          function RouterInitializer(injector) {
            this.injector = injector, this.resultOfPreactivationDone = new rxjs_Subject.Subject;
          }
          return RouterInitializer.prototype.appInitializer = function() {
            ...
            return p.then(function() {
              ...
              return opts.initialNavigation === !1 ? router.setUpLocationChangeListener() : (router.hooks.afterPreactivation = function() {
                return _this.initNavigation ? rxjs_observable_of.of(null) : (_this.initNavigation = !0, resolve(!0), _this.resultOfPreactivationDone);
              }, router.initialNavigation()), res;
            });
            ...
            if (bootstrappedComponentRef === ref.components[0]) {
              ...
              router.resetRootComponentType(ref.componentTypes[0]), this.resultOfPreactivationDone.next(null), this.resultOfPreactivationDone.complete();
            }
        ...
        VERSION = new _angular_core.Version("3.4.8"),
        __router_private__ = {
