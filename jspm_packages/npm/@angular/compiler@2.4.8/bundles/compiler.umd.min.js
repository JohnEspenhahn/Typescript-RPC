...
(function(process) {
    ...
    var ParseError = function() {
      ...
      return ParseError.prototype.toString = function() {
        var ctx = this.span.start.getContext(100, 3),
            contextStr = ctx ? ' ("' + ctx.before + "[ERROR ->]" + ctx.after + '")' : "",
 ...
 while (!this._isTextEnd());
    ...
    var _Visitor = function() {
      ...
      return _Visitor.prototype.extract = function(nodes, interpolationConfig) {
        ...
        XmlParser = function(_super) {
          ...
          return __extends$9(XmlParser, _super), XmlParser.prototype.parse = function(source, url, parseExpansionForms) {
        ...
        _SerializerIgnoreIcuExpVisitor = function(_super) {
          ...
          return __extends$10(_SerializerIgnoreIcuExpVisitor, _super), _SerializerIgnoreIcuExpVisitor.prototype.visitIcu = function(icu, context) {
            var _this = this,
                strCases = Object.keys(icu.cases).map(function(k) {
                  return k + " {" + icu.cases[k].visit(_this) + "}";
                });
    ...
    var Serializer = function() {
      function Serializer() {}
      return Serializer.prototype.write = function(messages) {}, Serializer.prototype.load = function(content, url) {}, Serializer.prototype.digest = function(message) {}, Serializer.prototype.createNameMapper = function(message) {
        return null;
      }, Serializer;
    }(),
        ...
        CR = function(_super) {
          ...
          return __extends$11(CR, _super), CR;
        }(Text$2),
        ...
        Xliff = function(_super) {
          ...
          return __extends$8(Xliff, _super), Xliff.prototype.write = function(messages) {
            var _this = this,
        ...
        Xmb = function(_super) {
          ...
          return __extends$12(Xmb, _super), Xmb.prototype.write = function(messages) {
            var _this = this,
            ...
            return messages.forEach(function(message) {
              ...
              if (!visited[id]) {
                ...
                var mapper = _this.createNameMapper(message),
                    attrs = {id: id};
                message.description && (attrs.desc = message.description), message.meaning && (attrs.meaning = message.meaning), rootNode.children.push(new CR(2), new Tag(_MESSAGE_TAG, attrs, visitor.serialize(message.nodes, {mapper: mapper})));
              }
        ...
        _Visitor$2 = function() {
          function _Visitor() {}
          return _Visitor.prototype.visitText = function(text, ctx) {
            return [new Text$2(text.value)];
            ...
            var startEx = new Tag(_EXEMPLE_TAG, {}, [new Text$2("<" + ph.tag + ">")]),
                name = ctx.mapper.toPublicName(ph.startName),
                startTagPh = new Tag(_PLACEHOLDER_TAG$1, {name: name}, [startEx]);
            if (ph.isVoid)
              return [startTagPh];
        ...
        XmbPlaceholderMapper = function() {
          function XmbPlaceholderMapper(message) {
            var _this = this;
            this.internalToXmb = {}, this.xmbToNextId = {}, this.xmbToInternal = {}, message.nodes.forEach(function(node) {
              return node.visit(_this);
            });
          }
          return XmbPlaceholderMapper.prototype.toPublicName = function(internalName) {
            ...
            var _this = this;
            this.addPlaceholder(ph.startName), ph.children.forEach(function(child) {
              return child.visit(_this);
            ...
            if (internalName && !this.internalToXmb.hasOwnProperty(internalName)) {
              ...
              if (this.xmbToInternal.hasOwnProperty(xmbName)) {
                ...
                this.xmbToNextId[xmbName] = nextId + 1, xmbName = xmbName + "_" + nextId;
              } else
                this.xmbToNextId[xmbName] = 1;
              this.internalToXmb[internalName] = xmbName, this.xmbToInternal[xmbName] = internalName;
            }
        ...
        Xtb = function(_super) {
          ...
          return __extends$13(Xtb, _super), Xtb.prototype.write = function(messages) {
            throw new Error("Unsupported");
        ...
        HtmlParser = function(_super) {
          ...
          return __extends$14(HtmlParser, _super), HtmlParser.prototype.parse = function(source, url, parseExpansionForms, interpolationConfig) {
        ...
        TranslationBundle = function() {
          function TranslationBundle(_i18nNodesByMsgId, digest, mapperFactory) {
            void 0 === _i18nNodesByMsgId && (_i18nNodesByMsgId = {}), this._i18nNodesByMsgId = _i18nNodesByMsgId, this.digest = digest, this.mapperFactory = mapperFactory, this._i18nToHtml = new I18nToHtmlVisitor(_i18nNodesByMsgId, digest, mapperFactory);
          }
        ...
        I18nToHtmlVisitor = function() {
          function I18nToHtmlVisitor(_i18nNodesByMsgId, _digest, _mapperFactory) {
            void 0 === _i18nNodesByMsgId && (_i18nNodesByMsgId = {}), this._i18nNodesByMsgId = _i18nNodesByMsgId, this._digest = _digest, this._mapperFactory = _mapperFactory, this._contextStack = [], this._errors = [];
          }
          return I18nToHtmlVisitor.prototype.convert = function(srcMsg) {
            ...
            if (this._i18nNodesByMsgId.hasOwnProperty(digest)) {
              this._contextStack.push({
                msg: this._srcMsg,
                mapper: this._mapper
              }), this._srcMsg = srcMsg, this._mapper = function(name) {
        ...
        ExpansionError = function(_super) {
          ...
          return __extends$15(ExpansionError, _super), ExpansionError;
        }(ParseError),
        _Expander = function() {
          function _Expander() {
        ...
        ProviderError = function(_super) {
          ...
          return __extends$16(ProviderError, _super), ProviderError;
        }(ParseError),
    ...
    var BoundProperty = function() {
      ...
      return Object.defineProperty(BoundProperty.prototype, "isLiteral", {
        ...
        PipeCollector = function(_super) {
          ...
          return __extends$17(PipeCollector, _super), PipeCollector.prototype.visitPipe = function(ast, context) {
    ...
    var PreparsedElement = function() {
      ...
      return PreparsedElement;
        ...
        RenderTypes = function() {
          ...
          return RenderTypes.prototype.renderer = function() {}, RenderTypes.prototype.renderText = function() {}, RenderTypes.prototype.renderElement = function() {}, RenderTypes.prototype.renderComment = function() {}, RenderTypes.prototype.renderNode = function() {}, RenderTypes.prototype.renderEvent = function() {}, RenderTypes;
        }(),
        ...
        AnimationStateAst = function(_super) {
          ...
          return __extends$19(AnimationStateAst, _super), AnimationStateAst.prototype.visit = function(visitor, context) {}, AnimationStateAst;
        }(AnimationAst),
        AnimationEntryAst = function(_super) {
          ...
          return __extends$19(AnimationEntryAst, _super), AnimationEntryAst.prototype.visit = function(visitor, context) {
        ...
        AnimationStateDeclarationAst = function(_super) {
          ...
          return __extends$19(AnimationStateDeclarationAst, _super), AnimationStateDeclarationAst.prototype.visit = function(visitor, context) {
        ...
        AnimationStateTransitionAst = function(_super) {
          ...
          return __extends$19(AnimationStateTransitionAst, _super), AnimationStateTransitionAst.prototype.visit = function(visitor, context) {
        ...
        AnimationStepAst = function(_super) {
          ...
          return __extends$19(AnimationStepAst, _super), AnimationStepAst.prototype.visit = function(visitor, context) {
        ...
        AnimationStylesAst = function(_super) {
          ...
          return __extends$19(AnimationStylesAst, _super), AnimationStylesAst.prototype.visit = function(visitor, context) {
        ...
        AnimationKeyframeAst = function(_super) {
          ...
          return __extends$19(AnimationKeyframeAst, _super), AnimationKeyframeAst.prototype.visit = function(visitor, context) {
        ...
        AnimationWithStepsAst = function(_super) {
          ...
          return __extends$19(AnimationWithStepsAst, _super), AnimationWithStepsAst;
        }(AnimationAst),
        AnimationGroupAst = function(_super) {
          function AnimationGroupAst(steps) {
            _super.call(this, steps);
          }
          return __extends$19(AnimationGroupAst, _super), AnimationGroupAst.prototype.visit = function(visitor, context) {
        ...
        AnimationSequenceAst = function(_super) {
          ...
          return __extends$19(AnimationSequenceAst, _super), AnimationSequenceAst.prototype.visit = function(visitor, context) {
        ...
        AnimationParseError = function(_super) {
          ...
          return __extends$18(AnimationParseError, _super), AnimationParseError.prototype.toString = function() {
            return "" + this.msg;
          }, AnimationParseError;
        }(ParseError),
        ...
        DirectiveNormalizer = function() {
          ...
          return DirectiveNormalizer.prototype.clearCache = function() {
            ...
            var interpolationConfig = InterpolationConfig.fromArray(prenomData.interpolation),
                rootNodesAndErrors = this._htmlParser.parse(template, stringify(prenomData.componentType), !0, interpolationConfig);
    ...
    var BuiltinType = function(_super) {
      ...
      return __extends$20(BuiltinType, _super), BuiltinType.prototype.visitType = function(visitor, context) {
        ...
        ExpressionType = function(_super) {
          ...
          return __extends$20(ExpressionType, _super), ExpressionType.prototype.visitType = function(visitor, context) {
        ...
        ArrayType = function(_super) {
          ...
          return __extends$20(ArrayType, _super), ArrayType.prototype.visitType = function(visitor, context) {
        ...
        MapType = function(_super) {
          ...
          return __extends$20(MapType, _super), MapType.prototype.visitType = function(visitor, context) {
    ...
    var ReadVarExpr = function(_super) {
      ...
      return __extends$20(ReadVarExpr, _super), ReadVarExpr.prototype.visitExpression = function(visitor, context) {
        ...
        WriteVarExpr = function(_super) {
          ...
          return __extends$20(WriteVarExpr, _super), WriteVarExpr.prototype.visitExpression = function(visitor, context) {
        ...
        WriteKeyExpr = function(_super) {
          ...
          return __extends$20(WriteKeyExpr, _super), WriteKeyExpr.prototype.visitExpression = function(visitor, context) {
        ...
        WritePropExpr = function(_super) {
          ...
          return __extends$20(WritePropExpr, _super), WritePropExpr.prototype.visitExpression = function(visitor, context) {
    ...
    var InvokeMethodExpr = function(_super) {
      ...
      return __extends$20(InvokeMethodExpr, _super), InvokeMethodExpr.prototype.visitExpression = function(visitor, context) {
        ...
        InvokeFunctionExpr = function(_super) {
          ...
          return __extends$20(InvokeFunctionExpr, _super), InvokeFunctionExpr.prototype.visitExpression = function(visitor, context) {
        ...
        InstantiateExpr = function(_super) {
          ...
          return __extends$20(InstantiateExpr, _super), InstantiateExpr.prototype.visitExpression = function(visitor, context) {
        ...
        LiteralExpr = function(_super) {
          ...
          return __extends$20(LiteralExpr, _super), LiteralExpr.prototype.visitExpression = function(visitor, context) {
        ...
        ExternalExpr = function(_super) {
          ...
          return __extends$20(ExternalExpr, _super), ExternalExpr.prototype.visitExpression = function(visitor, context) {
        ...
        ConditionalExpr = function(_super) {
          ...
          return __extends$20(ConditionalExpr, _super), ConditionalExpr.prototype.visitExpression = function(visitor, context) {
        ...
        NotExpr = function(_super) {
          ...
          return __extends$20(NotExpr, _super), NotExpr.prototype.visitExpression = function(visitor, context) {
        ...
        CastExpr = function(_super) {
          ...
          return __extends$20(CastExpr, _super), CastExpr.prototype.visitExpression = function(visitor, context) {
        ...
        FunctionExpr = function(_super) {
          ...
          return __extends$20(FunctionExpr, _super), FunctionExpr.prototype.visitExpression = function(visitor, context) {
        ...
        BinaryOperatorExpr = function(_super) {
          ...
          return __extends$20(BinaryOperatorExpr, _super), BinaryOperatorExpr.prototype.visitExpression = function(visitor, context) {
        ...
        ReadPropExpr = function(_super) {
          ...
          return __extends$20(ReadPropExpr, _super), ReadPropExpr.prototype.visitExpression = function(visitor, context) {
        ...
        ReadKeyExpr = function(_super) {
          ...
          return __extends$20(ReadKeyExpr, _super), ReadKeyExpr.prototype.visitExpression = function(visitor, context) {
        ...
        LiteralArrayExpr = function(_super) {
          ...
          return __extends$20(LiteralArrayExpr, _super), LiteralArrayExpr.prototype.visitExpression = function(visitor, context) {
        ...
        LiteralMapExpr = function(_super) {
          ...
          return __extends$20(LiteralMapExpr, _super), LiteralMapExpr.prototype.visitExpression = function(visitor, context) {
    ...
    var Statement = function() {
      ...
      return Statement.prototype.visitStatement = function(visitor, context) {}, Statement.prototype.hasModifier = function(modifier) {
        ...
        DeclareVarStmt = function(_super) {
          ...
          return __extends$20(DeclareVarStmt, _super), DeclareVarStmt.prototype.visitStatement = function(visitor, context) {
        ...
        DeclareFunctionStmt = function(_super) {
          ...
          return __extends$20(DeclareFunctionStmt, _super), DeclareFunctionStmt.prototype.visitStatement = function(visitor, context) {
        ...
        ExpressionStatement = function(_super) {
          ...
          return __extends$20(ExpressionStatement, _super), ExpressionStatement.prototype.visitStatement = function(visitor, context) {
        ...
        ReturnStatement = function(_super) {
          ...
          return __extends$20(ReturnStatement, _super), ReturnStatement.prototype.visitStatement = function(visitor, context) {
        ...
        ClassField = function(_super) {
          ...
          return __extends$20(ClassField, _super), ClassField;
        }(AbstractClassPart),
        ClassMethod = function(_super) {
          ...
          return __extends$20(ClassMethod, _super), ClassMethod;
        }(AbstractClassPart),
        ClassGetter = function(_super) {
          ...
          return __extends$20(ClassGetter, _super), ClassGetter;
        }(AbstractClassPart),
        ClassStmt = function(_super) {
          ...
          return __extends$20(ClassStmt, _super), ClassStmt.prototype.visitStatement = function(visitor, context) {
        ...
        IfStmt = function(_super) {
          ...
          return __extends$20(IfStmt, _super), IfStmt.prototype.visitStatement = function(visitor, context) {
        ...
        TryCatchStmt = (function(_super) {
          ...
          return __extends$20(CommentStmt, _super), CommentStmt.prototype.visitStatement = function(visitor, context) {
          ...
          return __extends$20(TryCatchStmt, _super), TryCatchStmt.prototype.visitStatement = function(visitor, context) {
        ...
        ThrowStmt = function(_super) {
          ...
          return __extends$20(ThrowStmt, _super), ThrowStmt.prototype.visitStatement = function(visitor, context) {
        ...
        _ReplaceVariableTransformer = function(_super) {
          ...
          return __extends$20(_ReplaceVariableTransformer, _super), _ReplaceVariableTransformer.prototype.visitReadVarExpr = function(ast, context) {
        ...
        _VariableFinder = function(_super) {
          ...
          return __extends$20(_VariableFinder, _super), _VariableFinder.prototype.visitReadVarExpr = function(ast, context) {
      ...
      return _AstToIrVisitor.prototype.visitBinary = function(ast, mode) {
        ...
        CompileMetadataResolver = function() {
          ...
          return CompileMetadataResolver.prototype.clearCacheFor = function(type) {
            ...
            return dirMeta || this._reportError(new SyntaxError("Illegal state: getDirectiveMetadata can only be called after loadNgModuleDirectiveAndPipeMetadata for a module that declares it. Directive " + stringifyType(directiveType) + "."), directiveType), dirMeta;
            ...
            return pipeMeta || this._reportError(new SyntaxError("Illegal state: getPipeMetadata can only be called after loadNgModuleDirectiveAndPipeMetadata for a module that declares it. Pipe " + stringifyType(pipeType) + "."), pipeType), pipeMeta;
        ...
        _CompileValueConverter = function(_super) {
          ...
          return __extends$21(_CompileValueConverter, _super), _CompileValueConverter.prototype.visitOther = function(value, targetIdentifiers) {
        ...
        _TsEmitterVisitor = function(_super) {
          ...
          return __extends$22(_TsEmitterVisitor, _super), _TsEmitterVisitor.prototype.visitType = function(t, ctx, defaultType) {
    ...
    var __extends$23 = this && this.__extends || function(d, b) {
      ...
      d.prototype = null === b ? Object.create(b) : (__.prototype = b.prototype, new __);
        ...
        DomElementSchemaRegistry = function(_super) {
          ...
          return __extends$23(DomElementSchemaRegistry, _super), DomElementSchemaRegistry.prototype.hasProperty = function(tagName, propName, schemaMetas) {
        ...
        _ReplaceViewTransformer = function(_super) {
          ...
          return __extends$25(_ReplaceViewTransformer, _super), _ReplaceViewTransformer.prototype._isThis = function(expr) {
        ...
        CompileElement = function(_super) {
          ...
          return __extends$24(CompileElement, _super), CompileElement.createNull = function() {
    ...
    var CompileViewRootNode = function() {
      ...
      return CompileViewRootNode;
        ...
        Serializer$1 = function(_super) {
          ...
          return __extends$26(Serializer, _super), Serializer.prototype.addOrMergeSummary = function(summary) {
        ...
        Deserializer = function(_super) {
          ...
          return __extends$26(Deserializer, _super), Deserializer.prototype.deserialize = function(json) {
            var _this = this,
        ...
        PopulatedScope = function(_super) {
          ...
          return __extends$27(PopulatedScope, _super), PopulatedScope.prototype.resolve = function(name) {
            return this.bindings.has(name) ? this.bindings.get(name) : BindingScope.missing;
          }, PopulatedScope;
        }(BindingScope),
        __extends$28 = this && this.__extends || function(d, b) {
          function __() {
            this.constructor = d;
          }
          for (var p in b)
          ...
          return StaticSymbolResolver.prototype.resolveSymbol = function(staticSymbol) {
            ...
            var self = this,
                ReferenceTransformer = function(_super) {
                  ...
                  return __extends$28(ReferenceTransformer, _super), ReferenceTransformer.prototype.visitStringMap = function(map, functionParams) {
        ...
        __extends$30 = this && this.__extends || function(d, b) {
          function __() {
            this.constructor = d;
          }
          for (var p in b)
        ...
        AbstractJsEmitterVisitor = function(_super) {
          ...
          return __extends$30(AbstractJsEmitterVisitor, _super), AbstractJsEmitterVisitor.prototype.visitDeclareClassStmt = function(stmt, ctx) {
            var _this = this;
        ...
        __extends$29 = this && this.__extends || function(d, b) {
          function __() {
            this.constructor = d;
          }
          for (var p in b)
        ...
        JitEmitterVisitor = function(_super) {
          ...
          return __extends$29(JitEmitterVisitor, _super), JitEmitterVisitor.prototype.getArgs = function() {
            for (var result = {},
        ...
        baseHtmlParser = new _angular_core.OpaqueToken("HtmlParser"),
        COMPILER_PROVIDERS = [{
          provide: Reflector,
          useValue: reflector
        }, {
